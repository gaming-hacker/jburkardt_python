...
#*****************************************************************************80
#
## dolfin-convert() converts various graphics formats for use by dolfin().
#
#  Usage:
#
...
#
    ...
    print ( "Options:" )
    print ( "" )
    print ( "  -h         display this help text, then quit." )
...
#
  ...
  if suffix == "xml":
    ...
    raise Exceptin ( "Sorry, unknown suffix %s." % suffix )
