...
#
#    real X(N), Y(N), the evalution points.
#
#  Output:
#
...
#
  if ( fi == 1 ):
    ...
    raise Exception ( 'f00_f0 - Fatal error!' )
...
#  Output:
#
#    real FX(N), FY(N), the first derivative values.
#
  if ( fi == 1 ):
    fx, fy = f01_f1 ( n, x, y )
  elif ( fi == 2 ):
    ...
    print ( '  Illegal function index FI = %d' % ( fi ) )
    raise Exception ( 'f00_f1 - Fatal error!' )
...
#  Output:
#
#    real FXX(N), FXY(N), FYY(N), the second derivatives.
#
  if ( fi == 1 ):
    ...
    print ( '  Illegal function index FI = %d' % ( fi ) )
    raise Exception ( 'f00_f2 - Fatal error!' )
...
#  Output:
#
#   integer FUN_num, the number of test functions.
#
  fun_num = 13
...
#  Output:
#
#    string TITLE, the function title.
#
  if ( fi == 1 ):
    title = f01_title ( )
  elif ( fi == 2 ):
    ...
    print ( '  Illegal function index FI = %d' % ( fi ) )
    raise Exception ( 'f00_title - Fatal error!' )
...
#  Output:
#
#    real FX(N), FY(N), the derivative values.
#
  import numpy as np
...
#  Output:
#
#    real FXX(N), FXY(N), FYY(N), second derivatives.
#
  import numpy as np
...
#  Input:
#
#    string file_name, the string to be incremented.
#
#  Output:
#
#    string file_name_NEXT, the incremented string.
#
#
...
#
  ...
  if ( flen <= 0 ):
    ...
    raise Exception ( 'file_name_sequence - Fatal error!' )
...
#  Output:
#
#   integer GRID_num, the number of grids.
#
  grid_num = 5
...
#
  if ( gi == 1 ):
    ...
    raise Exception ( 'g00_size - Fatal error!' )
...
#
  if ( gi == 1 ):
    ...
    print ( '  Illegal grid index GI = %d' % ( gi ) )
    raise Exception ( 'g00_title - Fatal error!' )
...
#  Output:
#
#    real GX(GN), GY(GN), the grid coordinates.
#
  if ( gi == 1 ):
    gx, gy = g01_xy ( gn )
  elif ( gi == 2 ):
    ...
    print ( '  Illegal grid index GI = %d' % ( gi ) )
    raise Exception ( 'g00_xy - Fatal error!' )
