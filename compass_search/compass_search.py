...
#
#    real X(M), the argument of the function.
#
#  Output:
#
#    real F, the value of the function at X.
#
  f1 = 1.5   - x[0] * ( 1.0 - x[1]      )
...
#
  ...
  print ( '  compass_search() handles beale().' )
  m = 2
  delta_tol = 0.00001
  delta = 0.1
  k_max = 20000
...
#*****************************************************************************80
#
## bohach1_test() tests Bohachevsky function #1.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( 'bohach1_test():' )
  print ( '  Python version: %s' % ( platform.python_version ( ) ) )
  print ( '  compass_search() handles the Bohachevsky function #1' )
  m = 2
  delta_tol = 0.00001
  delta = 0.3
  k_max = 20000
...
#
  ...
  print ( 'BOHACH2_test:' )
  print ( '  Python version: %s' % ( platform.python_version ( ) ) )
  print ( '  compass_search() handles the Bohachevsky function #2.' )
  m = 2
  delta_tol = 0.00001
  delta = 0.3
  k_max = 20000
...
#
  ...
  print ( 'BROYDEN_test:' )
  print ( '  Python version: %s' % ( platform.python_version ( ) ) )
  print ( '  compass_search() handles the Broyden function.' )
  m = 2
  delta_tol = 0.00001
  delta = 0.3
  k_max = 20000
...
#  Input:
#
#    function handle FUNCTION_HANDLE ( M, X ), a handle for the function
#    to be minimized.
#
#    integer M, the number of variables.
#
#    real X(M), a starting estimate for the minimizer.
#
#    real DELTA_TOL, the smallest step size that is allowed.
#
#    real DELTA, the starting stepsize.  
#
...
#
  ...
  if ( delta_tol <= 0 ):
    ...
    print ( '  DELTA_TOL <= 0.0.' )
    raise Exception ( 'compass_search - Fatal error!' )
...
#
  ...
  print ( '  Python version: %s' % ( platform.python_version ( ) ) )
  print ( '  compass_search() handles the extended Rosenbrock function.' )
  m = 4
  delta_tol = 0.00001
  delta = 0.3
  k_max = 20000
...
#
  ...
  print ( '  Python version: %s' % ( platform.python_version ( ) ) )
  print ( '  compass_search() handles the Goldstein-Price function.' )
  m = 2
  delta_tol = 0.00001
  delta = 0.3
  k_max = 20000
...
#
  ...
  print ( '  Python version: %s' % ( platform.python_version ( ) ) )
  print ( '  compass_search() handles the Himmelblau function.' )
  m = 2
  delta_tol = 0.00001
  delta = 0.3
  k_max = 20000
...
#
  ...
  print ( 'LOCAL_test:' )
  print ( '  Python version: %s' % ( platform.python_version ( ) ) )
  print ( '  compass_search() handles the Local function.' )
  m = 2
  delta_tol = 0.00001
  delta = 0.3
  k_max = 20000
...
#
  ...
  print ( 'MCKINNON_test:' )
  print ( '  Python version: %s' % ( platform.python_version ( ) ) )
  print ( '  compass_search() handles the McKinnon function.' )
  m = 2
  delta_tol = 0.00001
  delta = 0.3
  k_max = 20000
...
#
  ...
  print ( 'POWELL_test:' )
  print ( '  Python version: %s' % ( platform.python_version ( ) ) )
  print ( '  compass_search() handlesthe Powell function.' )
  m = 4
  delta_tol = 0.00001
  delta = 0.3
  k_max = 20000
...
#
  ...
  print ( '  Python version: %s' % ( platform.python_version ( ) ) )
  print ( '  compass_search() handles the Rosenbrock function.' )
  m = 2
  delta_tol = 0.00001
  delta = 0.3
  k_max = 20000
