...
#*****************************************************************************80
#
## spring_conserved() returns a conserved quantity for the spring ODE.
#
#  Discussion:
#
...
#*****************************************************************************80
#
## spring_deriv() returns the right hand side of the spring ODE.
#
#  Discussion:
#
...
#*****************************************************************************80
#
## spring_exact() returns the exact solution for the spring ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## spring_solve_ivp() uses solve_ivp() to solve the spring ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Use solve_ivp() to solve the spring ODE.' )
...
#
  ...
  plt.title ( 'spring, displacement: solve_ivp' )
...
#
  ...
  plt.xlabel ( '<-- Time -->' )
  plt.ylabel ( '<-- Velocity -->' )
  plt.title ( 'spring, velocity: solve_ivp' )
  plt.legend ( ( 'solve_ivp', 'exact' ) )
...
#
  ...
  plt.ylabel ( '<-- Velocity -->' )
  plt.title ( 'spring, phase: solve_ivp' )
  plt.legend ( ( 'solve_ivp', 'exact' ) )
...
#*****************************************************************************80
#
## spring_ode_test() tests spring_ode.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## spring_parameters() returns parameters for the spring ODE.
#
#  Discussion:
#
