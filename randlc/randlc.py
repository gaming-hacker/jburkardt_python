...
#*****************************************************************************80
#
## randlc_init() is a class for randlc().
#
#  Discussion:
#
...
#  Output:
#
#    real VALUE, the next pseudorandom value.
#
    if ( self.seed == 0.0 ):
...
#  Input:
#
#    integer K, the index of the desired value.
#
#  Output:
#
#    real VALUE, the K-th value in the sequence.
#
    if ( self.seed == 0.0 ):
      self.seed = 314159265.0
    elif ( self.seed < 0.0 ):
    ...
    if ( k < 0 ):
      ...
      print ( '  K < 0.' )
      raise Exception ( 'randlc_jump - Fatal error!' )
