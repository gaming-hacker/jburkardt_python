...
#*****************************************************************************80
#
## ozone_deriv() evaluates the derivative of the ozone ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## ozone_k1() evaluates rate coefficient k1 for the ozone ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## ozone_parameters returns parameters for the ozone ODE.
#
#  Discussion:
#
...
#*****************************************************************************80
#
## ozone_solve_ivp() uses solve_ivp() to solve the ozone ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Use solve_ivp() to solve the ozone ODE.' )
...
#
  ...
  plt.xlabel ( '<---  t  --->' )
  plt.ylabel ( '<---  h  --->' )
  plt.title ( 'ozone solve_ivp conservation' )
