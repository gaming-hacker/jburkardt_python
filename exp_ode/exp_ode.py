...
#*****************************************************************************80
#
## exp_backward_euler() uses the backward Euler method on the EXP ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Solve the EXP ODE using the backward Euler method.' )
  ...
  plt.xlabel ( '<-- t -->' )
  plt.ylabel ( '<-- y(t) -->' )
  plt.title ( ' EXP ODE, backward_euler method' )
...
#*****************************************************************************80
#
## exp_deriv() evaluates the right hand side of the exp ODE.
#
#  Discussion:
#
#    y' = alpha * y
...
#*****************************************************************************80
#
## exp_euler() uses euler() on the EXP ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Solve the EXP ODE using the Euler method.' )
  ...
  plt.xlabel ( '<-- t -->' )
  plt.ylabel ( '<-- y(t) -->' )
  plt.title ( ' EXP ODE, Euler method' )
  plt.legend ( ( 'Computed', 'Exact' ) )
...
#*****************************************************************************80
#
## exp_exact() evaluates the exact solution of the EXP ODE.
#
#  Discussion:
#
#    y' = alpha * y
...
#*****************************************************************************80
#
## exp_midpoint uses the midpoint method on the EXP ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Solve the EXP ODE using the midpoint method.' )
  ...
  plt.xlabel ( '<-- t -->' )
  plt.ylabel ( '<-- y(t) -->' )
  plt.title ( ' EXP ODE, midpoint method' )
  plt.legend ( ( 'Computed', 'Exact' ) )
...
#
  ...
  print ( '  Test exp_ode using euler(), backward_euler(), midpoint().' )
...
#*****************************************************************************80
#
## exp_parameters() returns the parameters of the exp ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
