...
#*****************************************************************************80
#
## beale_test() tests praxis() for the Beale function.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## box_test() tests praxis() for the Box function.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## chebyquad_test() tests praxis() for the Chebyquad function.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## cube_test() tests praxis() for the Cube function.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## helix_test() tests praxis() for the Fletcher-Powell Helix function.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## hilbert_test() tests praxis() for the Hilbert function.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## powell3d_test() tests praxis() for the Powell 3D function.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#    integer N, the number of variables.
#
#    integer JSEARCH, indicates the kind of search.
...
#
#    real L, is the parameter determining the particular
...
#
#    real F ( X, N ), the function to be minimized.
#
#    real X(N), the base point of the search.
#
#    integer NF, the function evaluation counter.
#
#    real V(N,N), a matrix whose columns constitute
#    search directions.
#
#    real Q0(N), Q1(N), two auxiliary points used to
#    determine the plane when a quadratic search is performed.
#
#    real QD0, QD1, values needed to compute the
#    coefficients QA, QB, QC.
#
#    real QA, QB, QC, coefficients used to combine
#    Q0, X, and A1 if a quadratic search is used.  (Yes, technically
#    these are input quantities as well.)
#
#  Output:
#
#    real VALUE, the value of the function at the
#    minimizing point.
#
#    integer NF, the function evaluation counter.
#
...
#
#    real TOL, a tolerance which determines when a vector
#    (a column or part of a column of the matrix) may be considered
#    "essentially" equal to zero.
#
#    real A(N,N), an array whose singular value decomposition is desired.
#
#  Output:
#
#    real A(N,N), the SVD orthogonal matrix factor V.
#
#    real Q(N), the singular values.
#
  import numpy as np
  ...
  for k in range ( n - 1, -1, -1 ):
    ...
    while ( True ):
      ...
      if ( kt_max < kt ):
        ...
        raise Exception ( 'minfit - Fatal error!' )
...
#
#    integer NITS, the maximum number of times the interval
#    may be halved to retry the calculation.
#
#    real D2, is either zero, or an approximation to
#    the value of (1/2) times the second derivative of F.
#
#    real X1, an estimate of the
#    distance from X to the minimum along V(*,J), or, if J = 0, a curve.
#
#    real F1, ?
#
#    logical FK if FK is TRUE, then on input F1 contains
#    the value flin(X1).
#
#    real F ( X, N ), the function to be minimized.  
#
...
#    real H, ?
#
#    real V(N,N), a matrix whose columns are direction
#    vectors along which the function may be minimized.
#
#    real Q0(N), an auxiliary point used to define
#    a curve through X.
#
#    real Q1(N), an auxiliary point used to define
#    a curve through X.
#
#    integer NL, the number of linear searches.
#
#    integer NF, the number of function evaluations.
#
#    real DMIN, an estimate for the smallest eigenvalue.
#
#    real LDT, the length of the step.
#
#    real FX, the value of F(X,N).
#
#    real QA, QB, QC, ?
#
#    real QD0, QD1, ?.
...
#    the value of (1/2) times the second derivative of F.
#
#    real X1, on the distance between X and the minimizer that was found.
#
#    real F1, ?
#
#    real X(N), ?
...
#  Input:
#
#    real T0, is a tolerance.  PRAXIS attempts to return
...
#
#    real H0, is the maximum step size.  H0 should be
...
#    integer N, the number of variables.
#
#    integer PRIN, controls printing intermediate results.
...
#       also printed.
#
#    real X(N), a guess of the point of minimum.
#
#    real F ( X, N ), the function to be minimized.
#
#  Output:
#
#    real VALUE, the function value at the minimizer.
#
#    real X(N), the estimated point of minimum.
#
#  Local:
#
#    real DMIN, an estimate for the smallest eigenvalue.
...
#    real FX, the value of F(X,N).
#
#    logical ILLC, is TRUE if the system is ill-conditioned.
#
#    real LDT, the length of the step.
#
#    integer NF, the number of function evaluations.
...
#    integer N, the number of variables.
#
#    real X(N), the current estimate of the minimizer.
#
#    integer PRIN, the user-specifed print level.
#    0, nothing is printed.
#    1, F is printed after every n+1 or n+2 linear minimizations.
#       final X is printed, but intermediate X is printed only
#       if N is at most 4.
...
#       also printed.
#
#    real FX, the smallest value of F(X) found so far.
#
#    integer NF, the number of function evaluations.
#
#    integer NL, the number of linear searches.
...
#    rea H, ?
#
#    real V(N,N), the matrix of search directions.
#
#    real Q0(N), an auxiliary point used to define
#    a curve through X.
#
...
#    real FX, the value of F(X,N).
#
#    real QF1, QA, QB, QC, QD0, QD1, ?
#
#  Output:
#
#    real X(N), ?
#
#    real Q0(N), an auxiliary point used to define a curve through X.
#
#    real Q1(N), an auxiliary point used to define a curve through X.
#
#    integer NL, the number of linear searches.
#
#    integer NF, the number of function evaluations.
...
#  Input:
#
#    integer N, the length of D, and the order of V.
#
#    real D(N), the vector to be sorted.
#
#    real V(N,N), an N by N array to be adjusted as D is sorted.
#
#  Output:
#
#    real D(N), the entries of D are in descending order.
#
#    real V(N,N), if the value that was in D(I) on input is
#    moved to D(J) on then the input column V(*,I) is moved to
...
#*****************************************************************************80
#
## rosenbrock_test() tests praxis() for the Rosenbrock function.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## singular_test() tests praxis() for the Powell Singular function.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## tridiagonal_test() tests praxis() for the Tridiagonal function.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## watson_test() tests praxis() for the Watson function.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## wood_test() tests praxis() for the Wood function.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
