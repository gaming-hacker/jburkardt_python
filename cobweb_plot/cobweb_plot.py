...
#  Input:
#
#    function f, a function of the form y = f(x).
#
#    real x0, the initial value of x.
#
#    integer N, the number of iterates.
#
#    real a, b, the range over which the function is to be studied.
#
