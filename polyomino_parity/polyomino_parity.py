...
#  Output:
#
#    integer S(): a row vector of integers corresponding to all possible sums of 
#    N1, N2, etc  choices from the sets {+Q1,-Q1}, {+Q2,-Q2}, etc
#    respectively
#
...
#
  ...
  if ( not i4_is_integer ( b ) ):
    print ( 'diophantine_nd_check: b is not an integer.' )
    return check
