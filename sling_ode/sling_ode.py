...
#*****************************************************************************80
#
## sling_conserved() returns a conserved quantity for the sling ODE.
#
#  Discussion:
#
...
#*****************************************************************************80
#
## sling_deriv() returns the right hand side of the sling ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## sling_ode_test() solves the sling ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## sling_parameters() returns parameters for the sling ODE.
#
#  Discussion:
#
...
#*****************************************************************************80
#
## sling_solve_ivp() tests sling_ode using solve_ivp().
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  title_string = ( 'sling solve_ivp: plot, s = %g' % ( s ) )
...
#
  ...
  plt.xlabel ( '<-- x -->' )
  plt.ylabel ( '<-- y -->' )
  title_string = ( 'sling solve_ivp: phase, s = %g' % ( s ) )
  plt.title ( title_string )
  plt.axis ( 'equal' )
...
#
  ...
  plt.xlabel ( '<-- Time -->' )
  plt.ylabel ( '<-- Energy -->' )
  title_string = ( 'sling solve_ivp: energy, s = %g' % ( s ) )
  plt.title ( title_string )
