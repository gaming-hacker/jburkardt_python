...
#*****************************************************************************80
#
## spring_peak_display() displays the peak values for the spring ODE solutions.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## spring_sweep() finds peak values of an ODE over a mesh of parameter values.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '' )
  print ( 'spring_sweep():' )
  print ( '  Tabulate the maximum solution value of the spring' )
  print ( '  ODE over a range of K and B values.' )
...
#*****************************************************************************80
#
## spring_sweep_ode_test: Parameter Sweep of an ODE
#
#  Discussion:
#
...
#
  ...
  print ( '  computing the solution of the ODE corresponding to each set.' )
