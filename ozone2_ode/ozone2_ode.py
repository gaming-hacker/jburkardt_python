...
#*****************************************************************************80
#
## ozone2_deriv() evaluates the derivative of the ozone2 ODE.
#
#  Discussion:
#
#    u1 = O
...
#*****************************************************************************80
#
## ozone2_k1() evaluates rate coefficient k1 for the ozone2 ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## ozone2_ode_test() solves the ozone2 ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## ozone2_parameters() returns parameters for the ozone2 ODE.
#
#  Discussion:
#
...
#*****************************************************************************80
#
## ozone2_solve_ivp uses solve_ivp() to solve the ozone ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Use solve_ivp() to solve the ozone2 ODE.' )
...
#
  ...
  plt.xlabel ( '<---  t  --->' )
  plt.ylabel ( '<---  h  --->' )
  plt.title ( 'ozone2 solve_ivp conservation' )
