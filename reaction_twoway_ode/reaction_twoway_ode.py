...
#*****************************************************************************80
#
## reaction_twoway_deriv(): right hand side of the twoway reaction ODE.
#
#  Discussion:
#
...
#*****************************************************************************80
#
## reaction_twoway_euler() solves the two way reaction ODE using euler().
#
#  Discussion:
#
...
#
  ...
  print ( '  Solve the two way reaction ODE using euler()' )
#
...
#
  ...
  title_string = ( 'reaction twoway euler: solution, k2 = %g' % ( k2 ) )
  ...
  title_string = ( 'reaction twoway euler conservation k2 = %g' % ( k2 ) )
  plt.title ( title_string )
...
#*****************************************************************************80
#
## reaction_twoway_exact() returns the exact solution of the twoway reaction ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## reaction_twoway_midpoint() solves the two way reaction ODE using midpoint().
#
#  Discussion:
#
...
#
  ...
  print ( '  Solve the two way reaction ODE using midpoint()' )
#
#  Get parameter values.
#
  k1, k2, t0, y0, tstop = reaction_twoway_parameters ( )
...
#
  ...
  plt.xlabel ( '<---  t  --->' )
  plt.ylabel ( '<---  Concentrations  --->' )
  title_string = ( 'reaction twoway midpoint: solution, k2 = %g' % ( k2 ) )
  plt.title ( title_string )
  plt.legend ( ( 'W1', 'W2', 'W1exact', 'W2exact', 'x axis' ) )
  ...
  plt.xlabel ( '<---  t  --->' )
  plt.ylabel ( '<---  conserved quantity  --->' )
  title_string = ( 'reaction twoway midpoint conservation k2 = %g' % ( k2 ) )
  plt.title ( title_string )
  plt.legend ( ( 'h', 'h initial', 'x axis' ) )
...
#*****************************************************************************80
#
## reaction_twoway_solve_ivp() solves the two way reaction ODE using solve_ivp.
#
#  Discussion:
#
#    The reference suggests an experiment in which the Forward Euler method
...
#
  ...
  print ( '  Solve the two way reaction ODE using solve_ivp()' )
#
#  Get parameter values.
#
  k1, k2, t0, y0, tstop = reaction_twoway_parameters ( )
...
#
  ...
  plt.xlabel ( '<---  t  --->' )
  plt.ylabel ( '<---  Concentrations  --->' )
  title_string = ( 'reaction twoway solve_ip: solution, k2 = %g' % ( k2 ) )
  plt.title ( title_string )
  plt.legend ( ( 'W1', 'W2', 'W1exact', 'W2exact', 'x axis' ) )
  ...
  plt.xlabel ( '<---  t  --->' )
  plt.ylabel ( '<---  conserved quantity  --->' )
  title_string = ( 'reaction twoway solve_ip conservation k2 = %g' % ( k2 ) )
  plt.title ( title_string )
  plt.legend ( ( 'h', 'h initial', 'x axis' ) )
...
#*****************************************************************************80
#
## reaction_twoway_ode_test() solves the two-way reaction ODE.
#
#  Discussion:
#
#    The reference suggests an experiment in which the Forward Euler method
...
#
  ...
  print ( '  Solve the two-way reaction ODE.' )
  print ( '' )
...
def reaction_twoway_parameters ( ):

#*****************************************************************************80
#
## reaction_twoway_parameters() returns parameters for the twoway reaction ODE.
#
#  Discussion:
#
...
#
#    real Y0[2]: the initial conditions.
#
