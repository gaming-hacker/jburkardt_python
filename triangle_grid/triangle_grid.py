...
#  Input:
#
#    real T(3,2), the coordinates of the vertices of the triangle.
#
#    integer NG, the number of grid points inside the triangle.
#
#    real TG(NG,2), the grid points.
#
...
#    integer N, the number of subintervals.
#
#    real T[3,2], the coordinates of the points
#    defining the triangle.
#
#  Output:
#
#    real TG[NG,2], the coordinates
