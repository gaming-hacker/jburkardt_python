...
#*****************************************************************************80
#
## duffing_deriv() evaluates the right hand side of the Duffing ODE.
#
#  Discussion:
#
...
#*****************************************************************************80
#
## duffing_solve_ivp uses solve_ivp() to solve the Duffing ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license. 
...
#
  ...
  print ( '  Use solve_ivp() to solve the duffing ODE.' )
...
#
  ...
  plt.xlabel ( '<-- t -->' )
  plt.ylabel ( '<-- y1(t) -->' )
  plt.title ( 'duffing solve_ivp : y1' )
...
#
  ...
  plt.xlabel ( '<-- t -->' )
  plt.ylabel ( '<-- y2(t) -->' )
  plt.title ( 'duffing solve_ivp: y2' )
...
#
  ...
  plt.xlabel ( '<-- y1(t) -->' )
  plt.ylabel ( '<-- y2(t) -->' )
  plt.title ( 'duffing solve_ivp: phase' )
...
#*****************************************************************************80
#
## duffing_ode_test() solves the Duffing ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license. 
...
#*****************************************************************************80
#
## duffing_parameters() returns the parameters of the Duffing ODE.
#
#  Discussion:
#
