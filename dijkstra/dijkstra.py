...
#  Input:
#
#    integer OHD(NV,NV), the distance of the direct link between
#    nodes I and J.
#
#  Output:
#
#    integer MIND(NV), the minimum distance from node 1 to each node.
#
  import numpy as np
#
...
#
    ...
    if ( mv == - 1 ):
      ...
      raise Exception ( 'DIJKSTRA_DISTANCE - Fatal error!' )
#
...
#  Input:
#
#    integer NV, the number of nodes.
#
#    integer MIND(NV), the currently computed minimum distance from
#    node 1 to each node.
#
#    integer CONNECTED(NV), is 1 for each connected node, whose 
#    minimum distance to node 1 has been determined.
#
#  Output:
#
#    integer D, the distance from node 1 to the nearest 
#    unconnected node.
#
#    integer V, the index of the nearest unconnected node.
#
  i4_huge = 2147483647 
...
#  Output:
#
#    int OHD(NV,NV), the distance of the direct link between
#    nodes I and J.
#
  import numpy as np
...
#  Input:
#
#    integer MV, the node whose minimum distance to node 1
...
#    nodes I and J.
#
#    integer MIND(NV), the currently computed minimum distances
