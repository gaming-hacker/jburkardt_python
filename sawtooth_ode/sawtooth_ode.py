...
#*****************************************************************************80
#
## sawtooth_deriv() returns the right hand side of the sawtooth ODE.
#
#  Discussion:
#
#    y1' = y2
...
#*****************************************************************************80
#
## sawtooth_driver() returns the driving term for the sawtooth ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  sawtooth_driver() evaluates the right hand side of the' )
  print ( '  sawtooth ODE.  Make a plot of it.' )
...
#*****************************************************************************80
#
## sawtooth_solve_ivp() tests sawtooth_ode with solve_ivp.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  plt.xlabel ( '<-- T -->' )
  plt.ylabel ( '<-- Y(1), Y(2) -->' )
  plt.title ( 'sawtooth ODE using solve_ivp()' )
...
#*****************************************************************************80
#
## sawtooth_ode_test() solves the sawtooth ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## sawtooth_parameters() returns parameters for the sawtooth ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
