...
#  Input:
#
#    integer L, the level of the set.
#    0 <= L
#
#  Output:
#
#    integer N, the order (number of points) in the set.
#
  n = 0
...
#  Output:
#
#    real XY(2,N), the Padua points of level L.
#
  import numpy as np
...
#
  ...
  if ( l == 0 ):
    ...
    raise Exception ( 'padua_points_set - Fatal error!' )
#
#  Transpose the array.
#
  xy = xy.transpose ( )
...
#  Output:
#
#    real W((L+1)*(L+2)/2), the quadrature weights.
#
  import numpy as np
...
#
  ...
  if ( l == 0 ):
    ...
    raise Exception ( 'padua_weights_set - Fatal error!' )
#
#  Reverse the indexing to match the published data.
#
  n = ( ( l + 1 ) * ( l + 2 ) ) // 2
