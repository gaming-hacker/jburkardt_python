...
#  Output:
#
#    real B(M,N), the normalized array.
#
  import numpy as np
...
#  Output:
#
#    real X(8,127), the snowfall data.
#
  import numpy as np
...
#
  ...
  filename = 'v_modes.png'
  plt.savefig ( filename )
  plt.show ( block = False )
  plt.close ( )

  print ( '' )
  print ( '  Plotted V modes 1 to 6 in "%s".' % ( filename ) )
