...
#
  ...
  print ( '  Solve the oregonator ODE.' )
...
#*****************************************************************************80
#
## oregonator_solve_ivp() solves the oregonator ODE using solve_ivp().
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Solve the oregonator ODE using solve_ivp().' )
...
#
  ...
  plt.title ( 'oregonator, solve_ivp, log10(x(t))' )
...
#
  ...
  plt.title ( 'oregonator, solve_ivp, log10(y(t))' )
...
#
  ...
  plt.title ( 'oregonator, solve_ivp, log10(z(t))' )
...
#
  ...
  ax.set_title ( 'oregonator, solve_ivp, log10(x,y,z)' )
