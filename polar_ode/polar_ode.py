...
#*****************************************************************************80
#
## polar_deriv() evaluates the right hand side of the polar ODE.
#
#  Discussion:
#
...
#*****************************************************************************80
#
## polar_exact() evaluates the exact solution of the polar ODE.
#
#  Discussion:
#
#    The variable Z(t) is complex, and has the formula:
...
#*****************************************************************************80
#
## polar_solve_ivp() uses solve_ivp() on the polar ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Solve the polar ODE using solve_ivp().' )
...
#
  ...
  plt.xlabel ( '<-- R(z) -->' )
  plt.ylabel ( '<-- I(z) -->' )
  plt.title ( ' polar, solve_ivp, phase' )
...
#
  ...
  plt.xlabel ( '<-- t -->' )
  plt.ylabel ( '<-- z(t) -->' )
  plt.title ( ' polar, solve_ivp, time' )
...
#
  ...
  print ( '  Solve the polar ODE, an ordinary differential equation (ODE)' )
...
#*****************************************************************************80
#
## polar_parameters() returns the parameters of the polar ODE.
#
#  Discussion:
#
