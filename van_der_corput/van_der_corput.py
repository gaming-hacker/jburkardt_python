...
#    I = 0 is allowed, and returns R = 0.
#
#    integer B, the base of the sequence.  The standard sequence
...
#
  if ( b < 2 ):
    ...
    raise Exception ( 'vdc_base - Fatal error!' )
#
...
#
  ...
  if ( 1.0 <= t ):
    ...
    raise Exception ( 'vdc_inverse - Fatal error!' )
...
#  Output:
#
#    real R(|I2+1-I1|), elements I1 through I2 of the van der
#    Corput sequence.
#
  import numpy as np
...
#*****************************************************************************80
#
## van_der_corput_test() test van_der_corput().
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license. 
