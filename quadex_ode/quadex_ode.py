...
#*****************************************************************************80
#
## quadex_backward_euler() applies the backward euler method to the quadex equation.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  plt.xlabel ( '<-- t -->' )
  plt.ylabel ( '<-- y(t) -->' )
  s = ( 'quadex ODE, backward euler method, n = %d' % ( n ) )
  plt.title ( s )
...
#*****************************************************************************80
#
## quadex_euler() applies the euler method to the quadex equation.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  plt.xlabel ( '<-- t -->' )
  plt.ylabel ( '<-- y(t) -->' )
  s = ( 'quadex ODE, euler method, n = %d' % ( n ) )
  plt.title ( s )
  plt.legend ( ( 'Computed', 'Exact' ) )
...
def quadex_parameters ( ):

#*****************************************************************************80
#
## quadex_parameters() returns the parameters of the quadex ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
