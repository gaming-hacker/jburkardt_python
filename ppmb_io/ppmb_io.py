...
#  Input:
#
#    integer WIDTH, HEIGHT, the number of columns and rows of data.
#    Reasonable values would be WIDTH = 200, HEIGHT = 600.
#
#  Output:
#
#    integer RGB[WIDTH*HEIGHT,3], the RGB data.
#
  import numpy as np
...
#
#    integer RGB[3,WIDTH*HEIGHT], a list of WIDTH*HEIGHT triples
