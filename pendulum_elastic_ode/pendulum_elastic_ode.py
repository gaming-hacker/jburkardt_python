...
#*****************************************************************************80
#
## pendulum_elastic_conserved(): conserved quantity for elastic pendulum ODE.
#
#  Discussion:
#
...
#*****************************************************************************80
#
## pendulum_elastic_deriv(): right hand side of the elastic pendulum ODE.
#
#  Discussion:
#
...
#
  ...
  print ( '  Solve the elastic pendulum ODE.' )
...
#*****************************************************************************80
#
## pendulum_elastic_parameters(): parameters for the elastic pendulum ODE.
#
#  Discussion:
#
...
#
  ...
  print ( '  Use solve_ivp() to solve the elastic pendulum ODE.' )
...
#
  ...
  plt.title ( 'pendulum elastic, solve_ivp: angular deflection.' )
...
#
  ...
  plt.xlabel ( '<-- Theta -->' )
  plt.ylabel ( '<-- ThetaDot -->' )
  plt.title ( 'pendulum elastic, solve_ivp: theta phase.' )
...
#
  ...
  plt.title ( 'pendulum elastic, solve_ivp: relative strain.' )
...
#
  ...
  plt.xlabel ( '<-- Nu -->' )
  plt.ylabel ( '<-- NuDot -->' )
  plt.title ( 'pendulum elastic, solve_ivp: nu phase.' )
...
#
  ...
  plt.xlabel ( '<-- Time -->' )
  plt.ylabel ( '<-- Energy -->' )
  plt.title ( 'pendulum elastic, solve_ivp: energy' )
