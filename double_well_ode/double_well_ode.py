...
#*****************************************************************************80
#
## double_well_conserved() returns a conserved quantity for the double_well ODE.
#
#  Licensing:
#
...
#*****************************************************************************80
#
## double_well_deriv() evaluates the derivative of the double_well ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## double_well_ode_test() solves the double_well ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Solve the double_well ODE.' )
...
def double_well_parameters ( t0_user = None, y0_user = None, tstop_user = None ):

#*****************************************************************************80
#
## double_well_parameters() returns the parameters of the double well ODE.
#
#  Discussion:
#
...
#*****************************************************************************80
#
## double_well_potential() evaluates the potential for the double_well ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## double_well_solve_ivp() uses solve_ivp() on the double_well ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Solve the double_well ODE using solve_ivp().' )
  ...
  plt.xlabel ( '<-- t -->' )
  plt.ylabel ( '<-- y(t) -->' )
  plt.title ( ' double well, solve_ivp, time plot' )
  plt.legend ( ( 'Q', 'P' ) )
  ...
  plt.xlabel ( '<-- Q -->' )
  plt.ylabel ( '<-- P -->' )
  plt.title ( ' double well, solve_ivp, phase plot' )
  ...
  plt.xlabel ( '<-- Time -->' )
  plt.ylabel ( '<-- H(t) -->' )
  plt.title ( 'double well, solve_ivp, conservation' )
