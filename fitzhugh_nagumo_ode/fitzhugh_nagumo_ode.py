...
#*****************************************************************************80
#
## fitzhugh_nagumo_deriv() returns the right hand side of the Fitzhugh-Nagumo ODE.
#
#  Discussion:
#
...
#*****************************************************************************80
#
## fitzhugh_nagumo_solve_ivp() calls solve_ivp() to solve the Fitzhugh-Nagumo ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Solve the Fitzhugh-Nagumo ODE using solve_ivp().' )
...
#
  ...
  plt.xlabel ( '<-- T -->' )
  plt.ylabel ( '<-- V(T), W(T) -->' )
  plt.title ( 'Fitzhugh-Nagumo solve_ivp' )
  plt.legend ( ( 'v(t)', 'w(t)' ) )
...
#
  ...
  plt.xlabel ( '<-- V(T) -->' )
  plt.ylabel ( '<-- W(T) -->' )
  plt.title ( 'Fitzhugh-Nagumo solve_ivp phase plot' )
...
#*****************************************************************************80
#
## fitzhugh_nagumo_ode_test() solves the Fitzhugh-Nagumo ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Solve the Fitzhugh-Nagumo ODE.' )
#
...
#*****************************************************************************80
#
## fitzhugh_nagumo_parameters() returns parameters of the Fitzhugh-Nagumo ODE.
#
#  Discussion:
#
