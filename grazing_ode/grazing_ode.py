...
#*****************************************************************************80
#
## grazing_deriv() evaluates the right hand side of the grazing ODE.
#
#  Licensing:
#
...
#*****************************************************************************80
#
## grazing_ode_test() solves the grazing ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## grazing_parameters() returns parameter values for the grazing ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## grazing_solve_ivp() solves the grazing ODE using solve_ivp().
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Solve the grazing ODE using solve_ivp().' )
...
#
  ...
  plt.title ( 'grazing ODE, solve_ivp: time plot' )
  ...
  plt.title ( 'grazing ODE, solve_ivp: phase plot' )
