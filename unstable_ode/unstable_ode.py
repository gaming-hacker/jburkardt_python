...
#
  ...
  v = mu * np.exp ( mu * t ) * (              np.cos ( t / mu ) - mu**2 * np.sin ( t / mu ) ) \
    +      np.exp ( mu * t ) * ( - 1.0 / mu * np.sin ( t / mu ) - mu    * np.cos ( t / mu ) )
...
#*****************************************************************************80
#
## unstable_parameters() returns the parameters of the unstable ODE.
#
#  Discussion:
#
