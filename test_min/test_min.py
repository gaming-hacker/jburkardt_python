...
#
  if ( problem == 1 ):
    ...
    print ( '  Illegal problem number = %d', problem )
    raise Exception ( 'p00_f1 - Fatal error!' )
...
#
  if ( problem == 1 ):
    ...
    print ( '  Illegal problem number = %d' % ( problem ) )
    raise Exception ( 'p00_f2 - Fatal error!' )
...
#  Output:
#
#    real F1, the first derivative of the
#    objective function.
#
  import numpy as np
