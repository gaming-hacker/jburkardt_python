...
#  Output:
#
#    real ARG, the currently considered point.  The user
...
#
#    integer STATUS.  The routine returns STATUS
...
#*****************************************************************************80
#
## zero_rc_test() tests zero_rc() on all test functions.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#    real A, B, the endpoints of the change of sign interval.
#
#    function F ( x ), the function whose zero is being sought.
#
...
#
  ...
  while ( True ):
    ...
    print ( '  %8d  %24.16g  %14g' % ( status, arg, value ) )
