...
#*****************************************************************************80
#
## stetter_backward_euler() uses the backward Euler method on the stetter ODE.
#
#  Discussion:
#
...
#*****************************************************************************80
#
## stetter_backward_euler_test() uses backward Euler method on the stetter ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Solve the stetter ODE using the backward Euler method.' )
...
#*****************************************************************************80
#
## stetter_deriv() evaluates the right hand side of the stetter ODE.
#
#  Discussion:
#
#    y' = lam(t) * y
...
#*****************************************************************************80
#
## stetter_euler() uses the Euler method on the stetter ODE.
#
#  Discussion:
#
...
#*****************************************************************************80
#
## stetter_euler_test() uses euler() on the stetter ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Solve the stetter ODE using euler().' )
...
#*****************************************************************************80
#
## stetter_lambda() evaluates the lambda factor of the stetter ODE.
#
#  Discussion:
#
#    y' = lam(t) * y
...
#
  ...
  print ( '  Plot lam(t) for the stetter ODE.' )
...
#*****************************************************************************80
#
## stetter_midpoint() uses the midpoint method on the stetter ODE.
#
#  Discussion:
#
...
#*****************************************************************************80
#
## stetter_midpoint_test() uses the midpoint method on the stetter ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Solve the stetter ODE using midpoint().' )
...
#*****************************************************************************80
#
## stetter_ode_test() solves the stetter ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#*****************************************************************************80
#
## stetter_parameters() returns the parameters of the stetter ODE.
#
#  Discussion:
#
...
#*****************************************************************************80
#
## stetter_trapezoidal() uses the trapezoidal method on the stetter ODE.
#
#  Discussion:
#
...
#*****************************************************************************80
#
## stetter_trapezoidal_test() uses the trapezoidal method on the stetter ODE.
#
#  Licensing:
#
#    This code is distributed under the GNU LGPL license.
...
#
  ...
  print ( '  Use stetter_trapezoidal() to solve the stetter ODE.' )
