...
#
  ...
  for i in range ( 0, 10 ):
    r8vec = r8vec_normal_01_sorted ( n )
...
def r8vec_uniform_01_sorted1 ( n ):
...
#
  ...
  for i in range ( 0, 10 ):
    r8vec = r8vec_uniform_01_sorted1 ( n )
    r8vec_transpose_print ( n, r8vec, '  R8VEC:' )
#
#  Terminate.
#
...
def r8vec_uniform_01_sorted2 ( n ):
...
#
  ...
  for i in range ( 0, 10 ):
    r8vec = r8vec_uniform_01_sorted2 ( n )
    r8vec_transpose_print ( n, r8vec, '  R8VEC:' )
#
#  Terminate.
#
